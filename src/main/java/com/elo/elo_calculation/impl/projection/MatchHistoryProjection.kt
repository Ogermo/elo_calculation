...
interface MatchHistoryProjection {
    val teamID : ID?
    val amount : Int
    val goals_given : Int
...
fun List<MatchHistoryProjection>.toTable() : String{
    var answer = "  <table border = '1'>" +
            "   <caption>Статистика обработанных матчей " +
            "(количество, победы/ничьи/поражения, забитые пропущенные мячи) указанной команды</caption>" +
            "   <tr>" +
            "    <th>teamID</th>" +
            "    <th>Match amount</th>" +
            "    <th>Goals given</th>"+
